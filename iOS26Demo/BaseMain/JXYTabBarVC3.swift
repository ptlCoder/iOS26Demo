...
class JXYTabBarVC3: UITabBarController {
...
extension JXYTabBarVC3 {
    ...
    func setUpChildViewController() {
        ...
        addChild(vc: vc1, title: "首页", norImageName: "consult_0", selImageName: "consult_15")

        
        let vc2 = SecondViewController()
        let nav2 = BaseNavViewController(rootViewController: vc2)
        addChild(vc: vc2, title: "通讯录", norImageName: "information_0", selImageName: "information_15")
        
        
        let vc3 = ThreeViewController()
        let nav3 = BaseNavViewController(rootViewController: vc3)
        addChild(vc: vc3, title: "", norImageName: "center_icon", selImageName: "center_icon")
        
        let vc4 = FourViewController()
        let nav4 = BaseNavViewController(rootViewController: vc4)
        addChild(vc: vc4, title: "搜索", norImageName: "mine_0", selImageName: "mine_15")
        
        let vc5 = SearchViewController()
        let nav5 = BaseNavViewController(rootViewController: vc5)
        addChild(vc: vc5, title: "我的", norImageName: "mine_0", selImageName: "mine_15")
...
extension JXYTabBarVC3 : UITabBarControllerDelegate {
